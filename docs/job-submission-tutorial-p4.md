...
9. Create a Seldon deployment in your cluster.
...
11. Make a prediction through curl.
    ...
    ![image.png](assets/jobsub-tt-p4-1.png)

12. You will get output like this

    ![image](assets/jobsub-tt-p4-2.png)
