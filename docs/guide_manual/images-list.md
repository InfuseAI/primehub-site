...
|-        |-     |-     |-    |
|TensorFlow 2.5|infuseai/docker-stacks:tensorflow-notebook-v2-5-0-3c245d1b|`CPU`|3.7|
|TensorFlow 2.5|infuseai/docker-stacks:tensorflow-notebook-v2-5-0-3c245d1b-gpu-cuda-11|`GPU`<br/>`CUDA 11`|3.7|
...
|TensorFlow 1.15|infuseai/docker-stacks:tensorflow-notebook-v1-15-4-3c245d1b|`CPU`|3.7|
|TensorFlow 1.15|infuseai/docker-stacks:tensorflow-notebook-v1-15-4-3c245d1b-gpu|`GPU`|3.7|
...
|Framework|Image|CPU / GPU|Python|
|-   |-    |-        |-     |
|PyTorch 1.8|infuseai/docker-stacks:pytorch-notebook-v1-8-0-3c245d1b|`CPU`|3.7|
|PyTorch 1.8|infuseai/docker-stacks:pytorch-notebook-v1-8-0-3c245d1b-gpu-cuda-11|`GPU`<br/>`CUDA 11`|3.7|
...
|-   |-    |-        |-     |
|AI notebook|infuseai/docker-stacks:ai-notebook-3c245d1b|`CPU`|3.7|
|AI notebook|infuseai/docker-stacks:ai-notebook-3c245d1b-gpu|`GPU`|3.7|
|AI notebook|infuseai/docker-stacks:ai-notebook-3c245d1b-gpu-cuda-11|`GPU`<br>`CUDA 11`|3.7|
