...
[snap](https://snapcraft.io/) will update packages automatically. If you plan use it in a production-ready environment, you could

* Set the update process run on a special time window, or delay it before a date
* Disalbe it by setting a wrong proxy
