---
id: version-3.6-model-management-tutorial
title: Manage and Deploy a Model
description: Manage and Deploy a Model
original_id: model-management-tutorial
---
...
1. Enter [Models](model-management) from User Portal then click on `MLflow UI` button.
![](assets/model-mgt-mlflow-ui-button.png)

1. In the MLflow UI, We will see a newly completed run under the `Default` experiment. Now clicking on this run.
